...
from .assets.blocks.bottleneck_residual2d_d import BottleneckResidual2DD
...
class BResNet162DD(tf.keras.Model):

    """

    Custom ResNet16 Network with Conv2D Convolutions and Bottleneck Residual blocks. 
    ...
    def __init__(self, units: int = 256, **kwargs) -> None:
        ...
        Constructor of the BResNet162DD network.
    ...
    def build(self, input_shape: Union[tf.TensorShape, tuple[int, int, int, int]]) -> None:
        ...
        Build method of the BResNet162DD network.
    ...
    def call(self, inputs: tf.Tensor) -> tf.Tensor:
        ...
        Call method of the BResNet162DD network.
    ...
    def compute_output_shape(self, input_shape: Union[tf.TensorShape, tuple[int, int, int, int]]) -> Union[tf.TensorShape, tuple[int, int]]:
        ...
        Method to compute the output shape of the BResNet162DD network.
    ...
    def get_config(self) -> dict[str, Any]:
        ...
        Method to get the configuration of the BResNet162DD network.
        ...
        -------
        config : dict
            Configuration of the BResNet162DD network.
    ...
    def from_config(cls, config):
        ...
        Method to set the configuration of the BResNet162DD network.
        ...
        model : tf.keras.Model
            The Loaded BResNet162DD network.
    ...
    @classmethod
    def build_from_config(cls, config: dict[str, Any]) -> "BResNet162DD":

        """

        Method to set the build configuration of the BResNet162DD network.
