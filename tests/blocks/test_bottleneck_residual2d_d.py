import unittest
from BResNet162DD.assets.blocks.bottleneck_residual2d_d import BottleneckResidual2DD
import tensorflow as tf
import inspect


class TestBottleneckResidual2DD(unittest.TestCase):

    def test_creation_init_layer(self):

        # Arrange and Act
        layer = BottleneckResidual2DD(filters=1, strides=(1, 1))
    ...
    def test_output_tensor_intended__shape(self):
        ...
        # Act
        output = BottleneckResidual2DD(filters=filters, strides=strides)(input_tensor)
    ...
    def test_get__config_init_matching__dict(self):
        ...
        init_params = [
            param.name
            for param in inspect.signature(BottleneckResidual2DD.__init__).parameters.values()
